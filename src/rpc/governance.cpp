...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
            ...
            "       \"vote-many\"          - Vote on a governance object by all masternodes (using masternode.conf setup)"},
                ...
                RPCResult{
            "Not documented by Bitcoin developers.\n"
                },
                RPCExamples{
    ...
    */
    ...
    if(strCommand == "prepare")
    {
        ...
        mapValue_t mapValue;
        pwallet->CommitTransaction(tx_new, std::move(mapValue), {} /* orderForm */, reservekey, g_connman.get(), state);
